  ...
  return (
    <MainLayout>
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Admin Groups Management</h1>
        <p className="text-gray-600 mb-6">Create and manage admin groups for visibility sharing between ADMINS</p>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            {groups.length === 0 ? (
              <p className="text-gray-500 text-center py-8">No admin groups created yet</p>
            ) : (
                  ...
                  <tbody>
                    {groups.map((group) => (
                      <tr key={group._id} className="border-b">
                        ...
                        <td className="px-4 py-2">{group.admins?.length || 0} admins</td>
